...
maximum:null,viewportMinimum:null,viewportMaximum:null,interval:null,intervalType:null,reversed:!1,logarithmic:!1,logarithmBase:10,title:null,titleFontColor:"white",titleFontSize:20,titleFontFamily:"arial",titleFontWeight:"normal",titleFontStyle:"normal",titleWrap:!0,titleMaxWidth:null,labelAngle:0,labelBackgroundColor:"transparent",labelFontFamily:"arial",labelFontColor:"black",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelAutoFit:!0,labelWrap:!0,labelMaxWidth:null,labelFormatter:null,
...
b)-k/2:Math.min(n.point.x,b)-k/2,p=Math.max(p,g));"vertical"===y&&(e+=h);r.x=p;r.y=e;r.render(!0);u&&("inside"!==w&&(0>m.indexOf("bar")&&n.point.x>c.x1&&n.point.x<c.x2||!z)&&(0>m.indexOf("column")&&n.point.y>c.y1&&n.point.y<c.y2||!z))&&(a.lineWidth=u,a.strokeStyle=s?s:"white",a.setLineDash&&a.setLineDash(F(q,u)),a.beginPath(),a.moveTo(n.point.x,n.point.y),0<=m.indexOf("bar")?a.lineTo(p+(0<n.direction?0:k),e+("horizontal"===y?h:-h)/2):0<=m.indexOf("column")?a.lineTo(p+k/2,e+((0<n.direction?h:-h)+("horizontal"===
