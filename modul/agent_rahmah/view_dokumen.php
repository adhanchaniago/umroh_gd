...
$pageSql = "SELECT jamaah_daftar.*, dokumen_super.pas_status, track_jamaah.packages_program, track_jamaah.kd_umroh, track_jamaah.depart
 ...
 WHERE packages_program='Rahmah' and travel = '$Travel' ";
...
if(isset($_POST['btnCari'])){
  if($_POST) {
    ...
    $mySql = "SELECT jamaah_daftar.*, dokumen_super.pas_status, track_jamaah.packages_program, track_jamaah.kd_umroh, track_jamaah.depart
     ...
     LEFT JOIN dokumen_super on jamaah_daftar.nomor_id=dokumen_super.id_dokumen
     LEFT JOIN track_jamaah on jamaah_daftar.nomor_id=track_jamaah.nomor_id
     WHERE  depart LIKE '%$txtKataKunci%' and packages_program='Rahmah' and travel = '$Travel'
  ...
  $mySql = "SELECT jamaah_daftar.*, dokumen_super.pas_status, track_jamaah.packages_program, track_jamaah.kd_umroh, track_jamaah.depart
   ...
   LEFT JOIN dokumen_super on jamaah_daftar.nomor_id=dokumen_super.id_dokumen
   LEFT JOIN track_jamaah on jamaah_daftar.nomor_id=track_jamaah.nomor_id
  WHERE packages_program='Rahmah' and travel = '$Travel' ORDER BY nomor_id ASC LIMIT $hal, $row";
}
...
<section class="content">
  ...
  <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                               ...
                               <?php
                               $bacaSql = "SELECT DISTINCT depart, packages_program FROM track_jamaah WHERE packages_program='Rahmah'";
  ...
  ?>
        ...
        <td style="text-align: center"><?php echo $view; ?></td>
         <td style="text-align: center"><?php echo $myData['pas_status']; ?></td>
          ...
          <td style="text-align: center"></td>
           <td style="text-align: center"></td>
        <td style="text-align: center"><center><a href="?page=Add_Document_Rahmah&NomorID=<?php echo $myData['nomor_id']; ?>" target="_self" alt="Edit Data" id=""  class='btn green btn-sm' title = "Input"><i class=" pe-7s-upload"></i></a>&nbsp;
        <td style="text-align: center"><center><a href="?page=Document_Personal_Rahmah&NomorID=<?php echo $myData['nomor_id']; ?>" target="_self" alt="Edit Data" id=""  class='btn green btn-sm' title = "Detail"><i class=" pe-7s-user"></i></a>&nbsp;
      </center>
    </font> </td>
         </tr>
        <?php } ?>
