...
<?php
session_start();
if($_SESSION['FirstName'] == 'DataJamaahRahmah') {header('Location: ?page=DataJamaahRahmah');} ;
...
<?php
  ...
  ?>
        ...
        <a href="?page=edit_jamaah&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data"  class='btn btn-xs btn-success ace-icon fa fa-pencil bigger-120' title="Edit"><i class="pe-7s-edit" ></i></a>&nbsp;
           <a href="?page=Document_Personal_Rahmah&NomorID=<?php echo $myData['nomor_id']; ?> " target="_self" alt="Detail Data" class='btn btn-xs btn-info ace-icon fa fa-eye bigger-120' title="Document"><i class="pe-7s-folder" ></i></a>&nbsp;
...
?>
        ...
        <?php
        echo "
            <a href='?page=DataJamaahRahmah&hal=$prev'>
        ...
        <li class="">
            ...
            for ($h = 1; $h <= $max; $h++) {
                $list[$h] = $row * $h - $row;
                echo " <a href='?page=DataJamaahRahmah&hal=$list[$h]'>$h</a> ";
            }
            ?>
        </li>
        <li class="next">
                <?php
        echo "
            <a href='?page=DataJamaahRahmah&hal=$next'>
