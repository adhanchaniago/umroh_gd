...
//  $tanggalLahir = "$cmbThnLahir-$cmbBlnLahir-$cmbTglLahir";
  ...
  if (count($pesanError)>=1 ){
    ...
    $mySql  = "INSERT INTO `jamaah` (nomor_id, date_input, title,  first_name,
                                      ...
                                      depart, arrival, room, nomor_room, no_pass, poi, doi, expired,
                                      Mahrom, mahrom_status, kd_umroh, petugas, travel)
                              ...
                              '$Depart', '$Arrival', '$Room', '$Room_number',  '$Passport', '$txtPoi', '$txtDoi', '$txtExpired'
                              , '$Mahrom' , '$Mahrom_Status', '$Kd_Umroh' , '$officer', '$travel')";

    $myQry  = mysql_query($mySql, $Link) or die ("Gagal query".mysql_error());

    //hapus data waiting
    $mySql = "DELETE FROM waiting WHERE waiting_id='$NomorUmroh'";
...
// Membaca Nomor Umroh
$NomorUmroh= isset($_GET['NomorUmroh']) ?  $_GET['NomorUmroh'] : '';
$mySql  = "SELECT waiting_id, title, first_name, last_name, surname, telepon, email, kd_umroh, packages_program, depart, arrival FROM waiting WHERE waiting_id='$NomorUmroh'";
$myQry  = mysql_query($mySql, $Link)  or die ("Query salah : ".mysql_error());
$myData = mysql_fetch_array($myQry);
$dataTitleWaiting  = $myData['title'];
$dataFirstNameWaiting = $myData['first_name'];
$dataLastNameWaiting = $myData['last_name'];
$dataSurnameWaiting = $myData['surname'];
$dataContactWaiting = $myData['telepon'];
$dataEmailWaiting = $myData['email'];
$dataPackagesProgramWaiting = $myData['packages_program'];
$dataDepartWaiting = $myData['depart'];
$dataArrivalWaiting = $myData['arrival'];
$dataKodeWaiting = $myData['kd_umroh'];
    ...
    ID
      ...
      <td>
        <select name="Title" required class="form-control col-xs-10 col-sm-5" style=" height: 35px; width: 100%" >
                  <option value="<?php echo "$dataTitleWaiting";?>"> <?php echo "$dataTitleWaiting";?></option>
      ...
      <tr>
      	...
      	<td>
        <input name="FirstName" type="text" name="ID" class="stacked-input" value="<?php echo $dataFirstNameWaiting; ?>"  id="input-1" placeholder="First Name *" required>
        </td>
      ...
      <tr>
        ...
        <td>
      <input name="LastName" type="text" name="ID" class="stacked-input" value="<?php echo $dataLastNameWaiting; ?>"  id="input-1" placeholder="Middle Name" >
        </td>
      ...
      <tr>
        ...
        <td>
    <input name="SurName" type="text" name="ID" class="stacked-input" value="<?php echo $dataSurnameWaiting; ?>"  id="input-1" placeholder="SurName" >
        </td>
...
" required />
  ...
  <select name="Status" required class="form-control col-xs-10 col-sm-5" style=" height: 35px; width: 100%"  >
      ...
      Email
        ...
        <td>
<input name="Email" type="text" name="ID" class="stacked-input" value="<?php echo "$dataEmailWaiting";?>"  id="input-1" placeholder="Email" >
        </td>
      ...
      Phone
        ...
        <td>
 <input  name="Contact" type="text" name="ID" class="stacked-input" value="<?php echo "$dataContactWaiting";?>"  id="input-1" placeholder="Contact Number*" required>
        </td>
      ...
      <input type="text" name="FamilyContact" class="stacked-input" value="<?php echo "$dataFamilyContact";?>"  id="input-1" placeholder="Family Contact" >
        ...
        <tr>
          <td class="text-center">
              ...
              <td>
  <input type="text" name="Kd_Umroh" class="stacked-input" value="<?php echo "$dataKodeWaiting";?>"  id="input-1" placeholder="Kode" required readonly="readonly">
<input name="jumlahpaket" type="hidden" value="1" />
              ...
              Packages Program
                    ...
                    <td>
<input type="text" name="Paket_Program" class="stacked-input" value="<?php echo $dataPackagesProgramWaiting; ?>"  id="input-1" placeholder="Umroh Packages" required readonly="readonly">
                            </td>
                        	</tr>
  ...
  Depart
        ...
        <td>
<input type="text" name="Depart" class="stacked-input" value="<?php echo $dataDepartWaiting; ?>"  id="input-1" placeholder="depart" required readonly="readonly">
                </td>
              </tr>
        ...
        Arrival
                ...
                <td>
   <input type="text" name="Arrival" class="stacked-input" value="<?php echo $dataArrivalWaiting; ?>"  id="input-1" placeholder="Arrival" required readonly="readonly">
                        </td>
                      </tr>
...
<input type="text" name="travel" class="stacked-input" style="width: 100%" value="<?php echo $_SESSION['Travel'];?>"  id="input-1" placeholder="Travel" readonly="readonly"/ >
  ...
  <button  type="submit" name="btnSimpan" value=" Submit " class="btn btn-info" style="width:100% ; height:50px ;background-color: #060b17;"  type="button">Save</button>
</form>
