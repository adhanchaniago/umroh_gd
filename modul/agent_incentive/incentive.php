...
if(isset($_POST['btnCari'])){
  if($_POST) {
    ...
    $mySql = "SELECT * FROM paket_umroh WHERE  depart_umroh LIKE '%$txtKataKunci%' and nama_paket='Incentive'
...
<?php
  ...
  ?>
        ...
        <td style="text-align: center"><center><font><a href="?page=input_jamaah_Incentive&NomorUmroh=<?php echo $myData['kd_umroh']; ?>" target="_self" alt="Edit Data" id="kuota"  class='btn green btn-sm' title = "Booking"><i class=" pe-7s-upload"></i></a>&nbsp;
