...
<?php
session_start();
if($_SESSION['FirstName'] == '') {header('Location: ?page=DataManifest_Super');} ;
...
WHERE packages_program='Berkah' and travel='$Travel' ORDER BY mahrom; ";
...
if(isset($_POST['btnCari'])){
  ...
  FROM track_jamaah
  LEFT JOIN jamaah_daftar on track_jamaah.nomor_id=jamaah_daftar.nomor_id
  WHERE packages_program='Berkah' and travel='$Travel' ORDER BY mahrom ASC LIMIT $hal, $row";
}
