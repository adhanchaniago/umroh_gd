...
<a style = "margin-top:15px;" href="?page=News_All_Incentive" class="btn-circle btn-sm"><i class="pe-7s-volume"></i></a>	&nbsp;
	...
	<div class="wrapper">
		<aside class="sidebar">
			...
			<h2 class="user-info__name">Hi <?php if ($_SESSION['FirstName'] == 'Sales') {echo 'Business Owner';}
				...
				<h3 class="user-info__role">Agent - Umroh Incentive <?php echo $_SESSION['Travel']; ?></h3>
			...
			<ul class="main-nav">
				<li class="main-nav--active">
					...
					<a class="main-nav__link" href='?page=Incentive_Agent' >
				...
				<li class="">
					<a class="main-nav__link" href='?page=DataWaiting_Incentive' type="submit" name="btnCari" value="search" >
					...
					Daftar Tunggu
								...
								<li class="">
									<a class="main-nav__link" href='?page=DataJamaahIncentive' type="submit" name="btnCari" value="search" >
			...
			<li class="">
				<a class="main-nav__link" href='?page=View_Document_Incentive' type="submit" name="btnCari" value="search" >
			...
			<li class="">
				<a class="main-nav__link" href='?page=Invoice_Incentive' type="submit" name="btnCari" value="search" >
