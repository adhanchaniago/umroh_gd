...
$view="<span class='btn inverse green'>5 </span>";
  ...
  ?>
        ...
        <td style="text-align: center"><center><a href="?page=Document_Personal_Incentive&NomorID=<?php echo $myData['nomor_id']; ?>" target="_self" alt="Edit Data" id=""  class='btn green btn-sm' title = "Detail"><i class=" pe-7s-user"></i></a>&nbsp;
      </center>
    </font> </td>
         </tr>
        <?php } ?>
