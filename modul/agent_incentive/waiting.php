...
$Petugas = $_POST['Petugas'];
  ...
  if (count($pesanError)>=1 ){
    ...
    $mySql  = "INSERT INTO `waiting` (date_input, title,  first_name,
                                      last_name, surname, gender, telepon, email, kd_umroh, packages_program,
                                      depart, arrival, travel, petugas)
                              VALUES (NOW(), '$Title', '$FirstName',
                              '$LastName', '$SurName', '$Gender', '$Contact', '$Email', '$Kode_Paket', '$Paket_Program',
                              '$Depart', '$Arrival', '$Agent', '$Petugas')";
 ...
 <input type="text" name="Arrival" class="stacked-input" value="<?php echo $dataArrival; ?>"  id="input-1" placeholder="Arrival" required>
  ...
  <div class="row">
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" class="form-horizontal" role="form">
              ...
              <tr>
                  <td>Salutation</td>
                  <td><select name="Title" required class="form-control" style=" height: 40px;" >
                              <option value="<?php echo "$dataTitle";?>"> Select Title*</option>
                               <option value="Mr">Mr</option>
                               <option value="Mrs">Mrs</option>
                               <option value="Miss">Miss</option>
              ...
              <tr>
                  <td>First Name</td>
                  <td><input name="FirstName" type="text" name="ID" class="stacked-input" value="<?php echo $dataFirstName; ?>"  id="input-1" placeholder="First Name *" required></td>
              </tr>
              <tr>
                  <td>Last Name</td>
                  <td><input name="LastName" type="text" name="ID" class="stacked-input" value="<?php echo $dataLastName; ?>"  id="input-1" placeholder="Last Name *" required></td>
              </tr>
              <tr>
                  <td>SurName</td>
                  <td><input name="SurName" type="text" name="ID" class="stacked-input" value="<?php echo $dataSurname; ?>"  id="input-1" placeholder="SurName *" required></td>
              </tr>
              <tr>
                  <td>Gender</td>
                  <td><select name="Gender" required class="form-control" style=" height: 40px;" >
                              <option value="<?php echo "$dataGender";?>"> Select Title*</option>
          ...
          <div class="col-md-4">
              ...
              <tr>
                <thead>
                  <th colspan="2">Contact and Reference</th>
                </thead>
              </tr>
                <tbody>
              ...
              <tr>
                  <td>Email</td>
                  <td><input name="Email" type="text" name="ID" class="stacked-input" value="<?php echo $dataEmail; ?>"  id="input-1" placeholder="Email*" required></td>
              </tr>
              <tr>
                  <td>Contact</td>
                  <td><input name="Contact" type="text" name="ID" class="stacked-input" value="<?php echo $dataContact; ?>"  id="input-1" placeholder="Contact*" required></td>
              </tr>
              <tr>
                  <td>Agent</td>
                  <td><input name="Agent" type="text" name="ID" class="stacked-input" style="background-color:blue" value="<?php echo $_SESSION['Travel']; ?>"  id="input-1" placeholder="Agent *" required readonly></td>
              </tr>
              <tr>
                  <td>Officer Agent</td>
                  <td><input name="Petugas" type="text" name="ID" class="stacked-input" style="background-color:blue" value="<?php echo $_SESSION['FirstName']; ?>"  id="input-1" placeholder="Officer *" required readonly></td>
              </tr>
              </tbody>
                </table>
							</div> <!-- /widget__content -->
          ...
          <div class="col-md-4">
            <article class="widget">
              ...
              <tr>
                  <td>Kd Packages</td>
                  <td> <input type="text" name="kode_paket" style="background-color:blue" class="stacked-input" value="<?php echo $dataKodePaket; ?>"  id="input-1" placeholder="Kode" required readonly>
</td>
              </tr>
              <tr>
                  <td>Packages Program</td>
                  <td><input type="text" name="Paket_Program" style="background-color:blue" class="stacked-input" value="<?php echo $dataUmroh; ?>"  id="input-1" placeholder="Umroh Packages" required readonly></td>
              </tr>
              <tr>
                  <td>Depart</td>
                  <td><input type="text" name="Depart" class="stacked-input" style="background-color:blue" value="<?php echo $dataKeberangkatan; ?>"  id="input-1" placeholder="depart" required readonly></td>
              </tr>
              <tr>
                  <td>Arrival</td>
                  <td><input type="text" name="Arrival" class="stacked-input" style="background-color:blue" value="<?php echo $dataArrival; ?>"  id="input-1" placeholder="Arrival" required readonly></td>
              </tr>
              </tbody>
                </table>
                    ...
                    <button  type="submit" name="btnSimpan" value=" Submit " class="btn btn-info" type="button" width="100%">Save</button>
                  </form>
                </div> <!-- /row -->
