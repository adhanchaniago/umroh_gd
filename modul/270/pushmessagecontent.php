...
<section class="content">
        ...
        <button onclick="window.location='?page=MessageContent';">Back</button>
...
<br>
        <form method ="POST" class ="widget widget__form" name ="form1" action ="?page=SavePushMessage" target = "_self" role ="form">
              <input type="text" class="stacked-input" name = "nama" placeholder="Name" value ="">
                 <input type="text" class="stacked-input" name ="description" placeholder="Description" value ="">
                  ...
                  <button type ="submit" onclick="window.location='?page=SavePushMessage';">Send</button>
