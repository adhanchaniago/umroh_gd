...
<section class="content">
      ...
      <article class="widget">
              ...
              <button onclick="window.location='?page=News-Add';">Add New</button>
                 </div>
               </article>
...
<tr>
  ...
  <td>
    ...
    <img src="modul/<?php echo $myData['image']; ?> "  height="400px"; style="padding-top:3px ;padding-left:10px";/></a>&nbsp;</div>
      ...
      <a href='modul/<?php echo $myData['image']; ?>' target='_blank'  title="News">
      <?php echo $myData['title']; ?></a></p></h3> <hr>
  ...
  <td>
<?php echo $myData['date_created']; ?> <br>
<?php echo $myData['created']; ?><hr>
 <a href="?page=News-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" class='btn red btn-sm'  onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA ... ?')" title='Delete'><i class="pe-7s-close"></i> Delete </a>
  </td>
...
?>
    ...
    <li class="" >
      ...
      for ($h = 1; $h <= $max; $h++) {
        $list[$h] = $row * $h - $row;
        echo " <a href='?page=NewsN&hal=$list[$h]'>$h</a> ";
      }
      ?>
    </li>
    <li class="next">
