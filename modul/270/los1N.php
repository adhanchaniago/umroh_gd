			...
			<header class = "main-header">
            	...
            	<li><a href ="?page=MarketingCampaign" onclick="window.location='?page=MarketingCampaign';">Marketing Campaign</a></li>
            	   <a href ="?page=LOS" onclick="window.location='?page=LOS';">Length Of Stay Campaign</a>
					...
					<button onclick="window.location='?page=AddLOS';">Add New</button>				            
         		 </div>
			</header>
							...
							<font><p> <?php echo $nomor; ?></p></font>			</td>
							 ...
							 <td>
							  ...
							  <p> <?php echo $myData['title']; ?></p>
                                        ...
                                        <td>
                                        <a href="?page=Edit-LOS1N&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data" title='Edit Data' ><i class="pe-7s-note"></i></a>

							  			</td>
							  			
							  			<td>
							  				<a href="?page=Delete-LOS1N&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data"  onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA ... ?')" title='Delete'><i class="pe-7s-close"></i></a>
...
?>
		...
		<li class="" >
			...
			for ($h = 1; $h <= $max; $h++) {
				$list[$h] = $row * $h - $row;
				echo " <a href='?page=LOS1N&hal=$list[$h]'>$h</a> ";
			}
			?>
		</li>
		<li class="next">
