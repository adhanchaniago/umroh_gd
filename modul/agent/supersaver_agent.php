...
$pageSql = "SELECT * FROM paket_umroh WHERE nama_paket='Berkah' ";
...
if(isset($_POST['btnCari'])){
  if($_POST) {
    ...
    $mySql = "SELECT * FROM paket_umroh WHERE  depart_umroh LIKE '%$txtKataKunci%' and nama_paket='Berkah'
          ORDER BY kd_umroh ASC LIMIT $hal, $row";
  }
}
else {
  $mySql = "SELECT * FROM paket_umroh WHERE nama_paket='Berkah' ORDER BY kd_umroh ASC LIMIT $hal, $row";
}
...
<!-- class="my_select_box" data-placeholder="Select Your Options" -->
  <select  name="txtKataKunci" bgcolor="blue" class="btn blue ">
                               ...
                               <?php
    $bacaSql = "SELECT distinct * FROM paket_umroh WHERE nama_paket='Berkah'";
