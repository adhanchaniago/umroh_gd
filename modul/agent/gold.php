...
<?php
  ...
  ?>
        ...
        <td style="text-align: center"><?php echo $view; ?> <?php echo $viewa; ?> <?php echo $selisih; ?> Day</td>
        <td style="text-align: center"><center><a href="?page=input_jamaah&NomorUmroh=<?php echo $myData['kd_umroh']; ?>" target="_self" alt="Edit Data" id="kuota"  class='btn green btn-sm' title = "Booking"><i class=" pe-7s-upload"></i></a>&nbsp;
...
?>
        ...
        <?php
        echo "
            <a href='?page=Incentive&hal=$prev'>
        ...
        <li class="">
            ...
            for ($h = 1; $h <= $max; $h++) {
                $list[$h] = $row * $h - $row;
                echo " <a href='?page=Incentive&hal=$list[$h]'>$h</a> ";
            }
            ?>
        </li>
        <li class="next">
                <?php
        echo "
            <a href='?page=Incentive&hal=$next'>
