...
if(isset($_POST['btnSimpan'])){
  ...
  if (count($pesanError)>=1 ){
    ...
    $mySql    = "UPDATE `los3n` SET 
            ...
            `URL`             = '$URL'
            WHERE id_los3n    ='".$_POST['txtKode']."'";


    $myQry=mysql_query($mySql, $Link) or die ("Gagal query".mysql_error());
    if($myQry){
      echo "<meta http-equiv='refresh' content='0; url=?page=LOS3N'>";
    }
    exit;
  } 
...
$mySql  = "SELECT * FROM los3n WHERE id_los3n='$Kode'";
