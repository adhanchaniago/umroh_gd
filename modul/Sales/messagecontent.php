...
<section class="content">
			<header class = "main-header">
               ...
               <div class="main-header__date">
					...
					<button onclick="window.location='?page=SalesTargetGroup';">Back</button>
                    <input hidden > 
                </div>
	</header>
...
<div class = "col-md-3">
		...
		<center><button class="btn blue fixed" onclick="window.location='?page=SalesEmailContent';">Create</button> </center> 
	...
	<div class = "col-md-3">
		...
		<center><button class="btn blue fixed" onclick="window.location='?page=SalesPushMessageContent';">Create</button> </center> 
