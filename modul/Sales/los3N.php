			...
			<header class = "main-header">
            	...
            	<li><a href ="?page=SalesMarketingCampaign">Marketing Campaign</a></li>
            	   <a href ="?page=SalesLOS" >Length Of Stay Campaign</a>
					...
					<button onclick="window.location='?page=SalesAddLOS3';">Add New</button>				            
         		 </div>
			</header>
...
<div class = "row">
  ...
  ?>	
							...
							<font><p><?php echo $myData['day']; ?></p></font>								
                                        ...
                                        <td>
                                        <a href="?page=SalesEdit-LOS3N&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data" title='Edit Data' ><i class="pe-7s-note"></i></a>

							  			</td>
							  			
							  			<td>
							  				<a href="?page=SalesDelete-LOS3N&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data"  onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA ... ?')" title='Delete'><i class="pe-7s-close"></i></a>
...
?>
		...
		<?php
		echo "
			<a href='?page=SalesLOS3N&hal=$prev'>
		...
		<li class="" >
			...
			for ($h = 1; $h <= $max; $h++) {
				$list[$h] = $row * $h - $row;
				echo " <a href='?page=SalesLOS3N&hal=$list[$h]'>$h</a> ";
			}
			?>
		</li>
		<li class="next">
				<?php
		echo "
			<a href='?page=SalesLOS3N&hal=$next'>
