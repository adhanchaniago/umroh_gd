...
backgroundColor:"transparent",
        ...
        animationEnabled: true,
            ...
            data: [
            {
                ...
                {y: 12, label: "Events.php"  },
                {y: 15, label: "Special-Offer.php"  },
                {y: 17, label: "Blog.php"  },
                {y: 18, label: "Silver.php"  },
                {y: 20, label: "Supersaver.php"  }
                            ]
                        }
                    ]
            });
    ...
    var chart1 = new CanvasJS.Chart("AttractivePage",
    {
      ...
      },
      {
       ...
       {y: 7, label: "Booking.php"  },
        ...
        {y: 5, label: "Events.php"  },
        {y: 4, label: "Special-Offer.php"  },
        {y: 9, label: "Gold.php"  },
        {y: 2, label: "Silver.php"  },
        {y: 6, label: "Supersaver.php"  }
