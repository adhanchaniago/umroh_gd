...
$pageSql = "SELECT * FROM jamaah WHERE packages_program='Incentive' ";
...
if(isset($_POST['btnCari'])){
  if($_POST) {
    ...
    $mySql = "SELECT * FROM jamaah WHERE  first_name LIKE '%$txtKataKunci%' and packages_program='Incentive'
          ORDER BY nomor_id ASC LIMIT $hal, $row";
  }
}
else {
  $mySql = "SELECT * FROM jamaah WHERE packages_program='Incentive' ORDER by nomor_id ASC LIMIT $hal, $row";
}
                        ...
                        <article class="widget">
                          <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" id="form1"  class="form-horizontal" role="form">
                                           <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                                             ...
                                             <?php
                  $bacaSql = "SELECT * FROM jamaah WHERE packages_program='Incentive'";
