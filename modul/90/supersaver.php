...
$pageSql = "SELECT * FROM paket_umroh WHERE nama_paket='Safwa' ";
...
if(isset($_POST['btnCari'])){
  ...
  $mySql = "SELECT * FROM paket_umroh WHERE nama_paket='Safwa' ORDER BY kd_umroh ASC LIMIT $hal, $row";
}
...
<section class="content">
  ...
  <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                               ...
                               <?php
    $bacaSql = "SELECT distinct * FROM paket_umroh WHERE nama_paket='Safwa'";
...
<?php
  ...
  // data untuk selisih tanggal
      $date1 = $myData['depart_umroh'];
        ...
        //  if (strtotime($selisih) < 1) {
        //    $hasil "<span class='btn inverse red'>Close</span>";
        //  }
  ...
  ?>
        ...
        <td style="text-align: center"><?php echo $view; ?> <?php echo $selisih; ?> Day</td>
