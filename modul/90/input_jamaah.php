...
// untuk input track umroh
    ...
    //                                   packages_program,
    //                                   depart, arrival, room,
    //                                   kd_umroh, staff, travel)
    //                           VALUES ('$kodeBaru', NOW(),
    //                           '$Paket_Program',
    //                           '$Depart', '$Arrival', '$Room',
    //                          '$Kd_Umroh' , '$officer', '$travel')";
    //
    // $myQry  = mysql_query($mySql, $Link) or die ("Gagal query".mysql_error());
          ...
          <select name="Mahrom_Status"  class="form-control" style=" height: 35px;" >
                        <option value="<?php echo "$dataMahromStatus";?>"> -Select Status Relation for Mahrom-</option>
                         ...
                         <option value="CHILD"> CHILD</option>
                          <option value="NEED MAHROM"> NEED MAHROM</option>
                  </select>
...
<input type="text" name="travel" class="stacked-input" style="width: 100%" value="<?php echo $_SESSION['Travel'];?>"  id="input-1" placeholder="Travel" readonly="readonly"/ >
  ...
  <button  type="submit" name="btnSimpan" value=" Submit " class="btn btn-info" style="width:100% ; height:50px ;background-color: blue;"  type="button">Save</button>
</form>
