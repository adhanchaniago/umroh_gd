...
<?php
  ...
  ?>
        ...
        <td> <a href="?page=DataEditMahromBerkah&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data" class='btn btn-xs btn-inverse ace-icon fa fa-pencil bigger-120'> Add Mahrom</a>&nbsp;
     </td>
         </tr>
        <?php } ?>
...
?>
        ...
        <?php
        echo "
            <a href='?page=DataMahromBerkah&hal=$prev'>
        ...
        <li class="">
            ...
            for ($h = 1; $h <= $max; $h++) {
                $list[$h] = $row * $h - $row;
                echo " <a href='?page=DataMahromBerkah&hal=$list[$h]'>$h</a> ";
            }
            ?>
        </li>
        <li class="next">
                <?php
        echo "
            <a href='?page=DataMahromBerkah&hal=$next'>
