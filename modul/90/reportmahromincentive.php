...
WHERE packages_program='Incentive' ORDER BY room; ";
...
if(isset($_POST['btnCari'])){
  ...
  FROM track_jamaah
  LEFT JOIN jamaah_daftar on track_jamaah.nomor_id=jamaah_daftar.nomor_id
  WHERE packages_program='Incentive' ORDER BY room ASC LIMIT $hal, $row";
}
            ...
            <header class="main-header">
                <div class="main-header__nav">
                    <h1 class="main-header__title">
                        ...
                        <span>Data Mahrom Incentive  </span>
                    </h1>
