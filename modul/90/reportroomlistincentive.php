...
WHERE packages_program='Incentive' ORDER BY room, nomor_room ASC; ";
    ...
    <div class="row">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" id="form1"  class="form-horizontal" role="form">
              <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                 ...
                 <?php
$bacaSql = "SELECT DISTINCT packages_program, depart FROM track_jamaah WHERE packages_program='Incentive'";
