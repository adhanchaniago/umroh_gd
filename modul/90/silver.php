...
$pageSql = "SELECT * FROM paket_umroh WHERE nama_paket='Marwa' ";
...
if(isset($_POST['btnCari'])){
  ...
  $mySql = "SELECT * FROM paket_umroh WHERE nama_paket='Marwa' ORDER BY kd_umroh ASC LIMIT $hal, $row";
}
...
<section class="content">
  ...
  <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                               ...
                               <?php
    $bacaSql = "SELECT distinct * FROM paket_umroh WHERE nama_paket='Marwa'";
