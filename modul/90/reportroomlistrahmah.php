...
WHERE packages_program='Rahmah' ORDER BY room, nomor_room ASC; ";
    ...
    <div class="row">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" id="form1"  class="form-horizontal" role="form">
              <select name="txtKataKunci" bgcolor="blue" class="btn blue ">
                 ...
                 <?php
$bacaSql = "SELECT DISTINCT packages_program, depart FROM track_jamaah WHERE packages_program='Rahmah'";
...
<?php
  ...
  ?>
        ...
        <tbody id="grad2" style="text-align: center">
        <tr>
        ...
        <td><?php echo $myData['room']; ?> <?php echo $myData['nomor_room']; ?></td>
